...
class LangVars
{
	...
	var $errValInPlace = 'Please correct the following fields';
	...
	var $ttlDispRecs   = 'Displaying <span id="%sstart_rec_num">%s</span> - <span id="%send_rec_num">%s</span> of <span id="%stotal_rec_num">%s</span> Records';
