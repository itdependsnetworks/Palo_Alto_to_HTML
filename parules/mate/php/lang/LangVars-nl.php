...
class LangVars
{
	...
	var $errValInPlace = 'Corrigeer de volgende velden';
	...
	var $ttlDispRecs   = 'In beeld <span id="%sstart_rec_num">%s</span> - <span id="%send_rec_num">%s</span> van <span id="%stotal_rec_num">%s</span> Rijen';
