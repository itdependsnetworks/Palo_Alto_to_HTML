...
class LangVars
{
	...
	var $errValInPlace = 'Por favor corrija los siguientes campos';
	...
	var $ttlDispRecs   = 'Mostrando <span id="%sstart_rec_num">%s</span> - <span id="%send_rec_num">%s</span> de <span id="%stotal_rec_num">%s</span> Registros';
