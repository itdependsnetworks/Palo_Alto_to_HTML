...
class LangVars
{
	...
	var $errValInPlace = 'S\'il vous plaît corriger les champs suivants';
	...
	var $ttlDispRecs   = 'Afficher <span id="%sstart_rec_num">%s</span> - <span id="%send_rec_num">%s</span> de <span id="%stotal_rec_num">%s</span> lignes';
