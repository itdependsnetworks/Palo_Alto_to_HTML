...
class LangVars
{
	...
	var $errValInPlace = 'Пожалуйста, исправьте следующие поля';
	...
	var $ttlDispRecs   = 'Отображается <span id="%sstart_rec_num">%s</span> - <span id="%send_rec_num">%s</span> из <span id="%stotal_rec_num">%s</span> записей';
