...
class LangVars
{
	...
	var $errValInPlace = 'Bitte korrigieren Sie die folgenden Felder';
	...
	var $ttlDispRecs   = 'Angezeigt sind die Datensätze <span id="%sstart_rec_num">%s</span> - <span id="%send_rec_num">%s</span> von insgesamt <span id="%stotal_rec_num">%s</span>';
